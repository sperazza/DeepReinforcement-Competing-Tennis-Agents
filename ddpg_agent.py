...
class DDPGAgent():
    ...
    def __init__(self, p):
        ...
        self.scheduler_critic = torch.optim.lr_scheduler.StepLR(self.critic_optimizer, step_size=1, gamma=.8)
        self.scheduler_actor = torch.optim.lr_scheduler.StepLR(self.actor_optimizer, step_size=1, gamma=.8)
    ...
    def reset_replay_buffer(self, p):
        self.memory = ReplayBuffer(p)
